<!--Muestra el header sin haber iniciado sesion-->
<header>
    <div id="header">
        <img src="/img/logo.png" alt="" class="d-none d-md-block">
        <span class="fondoBotonIrRegistro">
            <a href="?controller=producto&action=iniciarsesion" class="botonIrRegistro">Regístrate o inicia sesíon</a>
        </span>
    </div>
    <div id="menu">
